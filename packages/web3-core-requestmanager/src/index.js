...
var errors = require('../../web3-core-helpers/src/index').errors;
...
RequestManager.providers = {
    WebsocketProvider: require('../../web3-providers-ws/src/index'),
    HttpProvider: require('../../web3-providers-http/src/index'),
    IpcProvider: require('../../web3-providers-ipc/src/index')
};
